package com.pmo.app.repository;

import com.pmo.app.PmOooSApp;
import com.pmo.app.config.Constants;
import com.pmo.app.config.TestSecurityConfiguration;
import com.pmo.app.config.audit.AuditEventConverter;
import com.pmo.app.domain.PersistentAuditEvent;
...
import static com.pmo.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

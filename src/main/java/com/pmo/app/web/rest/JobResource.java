...
import com.pmo.app.repository.JobRepository;
import com.pmo.app.repository.search.JobSearchRepository;
...
/**
 * REST controller for managing {@link com.pmo.app.domain.Job}.
 */
@RestController
@RequestMapping("/api")
public class JobResource {
    ...
    private static final String ENTITY_NAME = "pmOooSJob";
